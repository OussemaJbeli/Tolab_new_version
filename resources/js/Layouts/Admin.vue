                        ...
                        <div class="flex nave_options">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex options_nave">
                                ...
                                <NavLink :href="route('admin_taleb.users')" :active="route().current('admin_taleb.users')" class="NavLink pl-2" v-if="$page.props.auth.user.admin">
                                    <i class="fa-solid fa-users"  :style="{ right: (sid_bar || test_side)? '' : '15px' }"></i>
                                    <span :style="{ visibility: (sid_bar || test_side)? '' : 'hidden' }">المستخدمون</span>
                                </NavLink>
                                <NavLink :href="route('admin_taleb.payment_plans')" :active="route().current('admin_taleb.payment_plans')" class="NavLink pl-2" v-if="$page.props.auth.user.admin">
                                    <i class="fa-solid fa-coins"  :style="{ left: (sid_bar || test_side)? '' : '15px' }"></i>
                                    <span :style="{ visibility: (sid_bar || test_side)? '' : 'hidden' }">خطط الدفع</span>
                                </NavLink>
                                <NavLink :href="route('profile.edit_admin')" :active="route().current('profile.edit')" class="NavLink pl-2">
