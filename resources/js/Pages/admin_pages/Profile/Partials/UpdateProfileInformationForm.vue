...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-white">معلومات الملف الشخصي</h2>
        ...
        <form @submit.prevent="form.patch(route('profile.update'))" class="mt-6 space-y-6">
            ...
            <div>
                <InputLabel for="email" value="بريد إلكتروني" />
            ...
            <div class="flex items-center gap-4">
                ...
                >
                    <p v-if="form.recentlySuccessful" class="text-sm text-gray-200"> نم الحفظ.</p>
                </Transition>
            </div>
        </form>
    </section>
