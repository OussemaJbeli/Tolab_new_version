...
class Play_listController extends Controller
{
     ...
     */
    //play_list
    public function playlist_AUTH(string $id_chanel)
    {
        session(['selected_channel_id' => $id_chanel]);
        
        $play_list = Play_list::where('id_chanel', $id_chanel)
        ->get();

        $videos_with_playlist = Videos::where('id_chanel', $id_chanel)
        ...
        $videos_without_playlist = Videos::where('id_chanel', $id_chanel)
